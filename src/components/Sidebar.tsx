...
let sidebaritems = [{
    id:"1",
    thumb:<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events: none; display: inherit; width: 100%; height: 100%;"><path clipRule="evenodd" d="M22.146 11.146a.5.5 0 01-.353.854H20v7.5a1.5 1.5 0 01-1.5 1.5h-5v-7h-3v7h-5A1.5 1.5 0 014 19.5V12H2.207a.5.5 0 01-.353-.854L12 1l10.146 10.146ZM18.5 9.621l-6.5-6.5-6.5 6.5V19.5H9V13a.5.5 0 01.5-.5h5a.5.5 0 01.5.5v6.5h3.5V9.621Z" fillRule="evenodd"></path></svg>
  ,
    label: "Home"
},
{
...
{
    id:"4",
    thumb:<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events: none; display: inherit; width: 100%; height: 100%;"><path d="m11 7 6 3.5-6 3.5V7zm7 13H4V6H3v15h15v-1zm3-2H6V3h15v15zM7 17h13V4H7v13z"></path></svg>,
    label: "You"
}
,
{
...
,
{
    ...
    thumb:<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" enableBackground="new 0 0 24 24" xmlSpace="preserve" focusable="false" aria-hidden="true" className="pointer-events: none; display: inherit; width: 100%; height: 100%;">
    <g>
      <circle id="XMLID_4814__yt257" fill="#FF0033" cx="12" cy="12" r="11"></circle>
...
export const Sidebar = () => {
    return <div className="bg-gray-950 w-48 hidden md:block pt-3	">
      <BarWithIcon />
    </div>
}
    ...
    return (
        <div  >
           {sidebaritems.map(item => 
                <BarElement key={item.id} icon={item.thumb} label={item.label} />
            )}
        </div>
    );
}
...
function BarElement({icon, label}: {icon: any; label: string;}) {
    return (<div className="w-full	 rounded-sm bg-slate-950 hover:bg-gray-700 flex  p-2 m-2 cursor-pointer ">
        <div className="pr-2">
            {icon}
        </div>
